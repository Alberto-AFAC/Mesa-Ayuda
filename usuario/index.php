...
$actual = date('Y-m-d');
$hactual = date('H:i:s');
$queri ="SELECT * FROM reporte WHERE n_empleado = $n_empleado AND finicio = '$actual' AND pila != 'WEB' ORDER BY n_reporte DESC";
...
<option value="AFAC - AIFA">AFAC - AIFA</option>
<?php while($row = mysqli_fetch_assoc($resultado)){ 
    if($row['sede']=='WEB'){}else{?>
