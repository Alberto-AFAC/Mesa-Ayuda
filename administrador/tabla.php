...
WHERE usuarios.privilegios = 'manejador' and comentario.id_climan = $id and comentario.visto = 0 and comentario.estado = 1 order by id asc";
...
<?php 
$sql = "
SELECT DISTINCT id_climan,nombre FROM comentario WHERE id_usu = $id and estado = 1 ORDER BY id_climan ASC

/*SELECT DISTINCT id_manejador, manejador.nombre, manejador.apellidos FROM manejador INNER JOIN comentario ON id_manejador = id_climan WHERE comentario.estado = 1 and id_manejador != $id order by id_manejador asc
*/
