...
html = '<div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"> <div class="col-sm-12"><table id="historial" class="table-bordered table table-hover" style="width:100%" role="grid" aria-describedby="example_info"><thead><tr><th><i class="fa fa-sort-numeric-asc"></i></th><th><i></i> Instalación Portuaria</th><th><i></i> Estado</th><th><i></i> Puerto</th><th><i></i>Ciclo</th><th><i></i>Epip</th><th><i></i>Ppip</th><th><i></i>Aud_Cert</th><th><i></i>Re.AC</th><th><i></i>DCIP Exp.</th><th><i></i>DCIP Vig.</th><th>Holog.</th><th colspan="2">Auditoria / Resellado 1 </th><th colspan="2">Auditoria / Resellado 2 </th><th colspan="2">Auditoria / Resellado 3 </th><th colspan="2">Auditoria / Resellado 4 </th><th><i></i>OBS</th></tr></thead><tbody>';
...
if(f1<f2epip && obj.data[i].ppip == '0000-00-00'){
 fec_ppip = ('Ha '+restante+' días').fontcolor('green');          
...
if(f1<f2ppip && obj.data[i].aud_cert == '0000-00-00'){
 fec_aud_cert = ('Ha '+restante+' días').fontcolor('green');          
...
fec_auditoria1 = ('Ha '+restante+' días').fontcolor('green');          
...
fec_auditoria2 = ('Ha '+restante+' días').fontcolor('green');          
...
fec_auditoria3 = ('Ha '+restante+' días').fontcolor('green');          
...
fec_auditoria4 = ('Ha '+restante+' días').fontcolor('green');          
...
estado = obj.data[i].estado.charAt(0).toUpperCase() + obj.data[i].estado.slice(1).toLowerCase();
  ...
  if(fecha_agregada == '0000-00-00'){
     html +="<tr style='background:rgba(0,0,0,0.3);'><td>"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+"</td><td>"+estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_re_ac+"</td><td>"+fec_dcip_exp+"</td><td>"+'sin registro'.fontcolor('red')+"</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td>"+obj.data[i].observ+"</td></tr>";
  }else if(f2vig < f1){
     html +="<tr style='background:rgba(0,0,0,0.3);'><td>"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+"</td><td>"+estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_re_ac+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' vencida'.fontcolor('red')+"</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td>"+obj.data[i].observ+"</td></tr>";  
  }
