...
if(fecha_agregada == '0000-00-00'){
     html +="<tr class='danger'><td><input type='hidden' id='idsip' value="+obj.data[i].int_por+">"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+'. '+estado+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+'sin tramitar'.fontcolor('red')+"</td><td>"+fec_auditoria1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_auditoria4+"</td><td><div class='btn-group'><a class='Editar btn btn-default' href='#' data-toggle='modal' data-target='#modalDetalles' onclick='Detalle("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-th-list'></i></a></div></td></tr>";
}else if(f2vig < f1){
     html +="<tr class='danger'><td><input type='hidden' id='idsip' value="+obj.data[i].int_por+">"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+'. '+estado+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' vencida'.fontcolor('red')+"</td><td>"+fec_auditoria1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_auditoria4+"</td><td><div class='btn-group'><a class='Editar btn btn-default' href='#' data-toggle='modal' data-target='#modalDetalles' onclick='Detalle("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-th-list'></i></a></div></td></tr>";  
}else{
...
if(obj.data[i].numero == "" || obj.data[i].instalacion_portuaria == "" || obj.data[i].estado == "" || obj.data[i].puerto == "" || obj.data[i].epip == "" || obj.data[i].ppip == "" || obj.data[i].aud_cert == "" || obj.data[i].re_ac == "" || obj.data[i].dcip_exp == "" || obj.data[i].dcip_vig == "" || obj.data[i].holograma == "" || obj.data[i].auditoria1 == "" || obj.data[i].resellado1 == "" || obj.data[i].auditoria2 == "" || obj.data[i].resellado2 == "" || obj.data[i].auditoria3 == "" || obj.data[i].resellado3 == "" || obj.data[i].auditoria4 == "" || obj.data[i].resellado4 == "" || obj.data[i].actividad_realizar == "" || obj.data[i].actividad_vigencia == "" || obj.data[i].status == "" || obj.data[i].activo_historico == "" || obj.data[i].tipo == "" || obj.data[i].obser == ""){
   html +="<tr class='warning'><td><input type='hidden' id='idsip' value="+obj.data[i].int_por+">"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+'. '+estado+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+ (" fal. "+diferencia+" días</td><td>"+fec_auditoria1).fontcolor('#00a6ce')+"</td><td>"+fec_auditoria2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_auditoria4+"</td><td><div class='btn-group'><a class='Editar btn btn-default' href='#' data-toggle='modal' data-target='#modalDetalles' onclick='Detalle("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-th-list'></i></a></div></td></tr>";  
}else{
   html +="<tr><td><input type='hidden' id='idsip' value="+obj.data[i].int_por+">"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+'. '+estado+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+ (" fal. "+diferencia+" días</td><td>"+fec_auditoria1).fontcolor('#00a6ce')+"</td><td>"+fec_auditoria2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_auditoria4+"</td><td><div class='btn-group'><a class='Editar btn btn-default' href='#' data-toggle='modal' data-target='#modalDetalles' onclick='Detalle("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-th-list'></i></a></div></td></tr>";    
      }
          }
...
$.ajax({
    ...
    for(i=0;i<res.length;i++){
        ...
        var idip = $("#modalDetalles #idip").val(obj.data[i].id_proce);
        estado = obj.data[i].estado.charAt(0).toUpperCase() + obj.data[i].estado.slice(1).toLowerCase();    
        puertos = obj.data[i].puerto+', '+estado;
        var puerto = $("#modalDetalles #puerto").val(puertos);
        ...
        var observ = $("#modalDetalles #observ").val(obj.data[i].observacion);
           }
