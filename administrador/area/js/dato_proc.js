...
if(fecha_agregada == '0000-00-00'){
     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+'sin tramitar'.fontcolor('red')+"</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proce+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-primary' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-header'></i></a></div></td></tr>";
}else if(f2vig < f1){
     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' vencida'.fontcolor('red')+"</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proce+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-primary' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-header'></i></a></div></td></tr>";  
}else{
...
if(obj.data[i].numero == "" || obj.data[i].instalacion_portuaria == "" || obj.data[i].estado == "" || obj.data[i].puerto == "" || obj.data[i].epip == "" || obj.data[i].ppip == "" || obj.data[i].aud_cert == "" || obj.data[i].re_ac == "" || obj.data[i].dcip_exp == "" || obj.data[i].dcip_vig == "" || obj.data[i].holograma == "" || obj.data[i].auditoria1 == "" || obj.data[i].resellado1 == "" || obj.data[i].auditoria2 == "" || obj.data[i].resellado2 == "" || obj.data[i].auditoria3 == "" || obj.data[i].resellado3 == "" || obj.data[i].auditoria4 == "" || obj.data[i].resellado4 == "" || obj.data[i].actividad_realizar == "" || obj.data[i].actividad_vigencia == "" || obj.data[i].status == "" || obj.data[i].activo_historico == "" || obj.data[i].tipo == "" || obj.data[i].obser == ""){
   html +="<tr class='warning'><td>"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' fal. '+diferencia+" días</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proce+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-primary' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-header'></i></a></div></td></tr>";  
}else{
   html +="<tr><td>"+x+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' fal. '+diferencia+" días</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proce+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-primary' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proce+'"'+")'><i class='glyphicon glyphicon-header'></i></a></div></td></tr>";    
      }
          }
...
$.ajax({
    ...
    for(i=0;i<res.length;i++){
        var idt = obj.data[i].id_proce;
        if(id_proce===idt){        


        var idpro = $("#modalEdicion #idpro").val(obj.data[i].id_proce);    
        var numero = $("#modalEdicion #numero").val(obj.data[i].numero);
  
        estado = obj.data[i].estado.charAt(0).toUpperCase() + obj.data[i].estado.slice(1).toLowerCase();
        puertos = obj.data[i].puerto+','+estado;

        var puerto = $("#modalEdicion #puerto").val(puertos);
        ...
        var observ = $("#modalEdicion #observ").val(obj.data[i].observacion);
           }
        }
    });
}

function preguntarSiNoIP(id_proce){
    console.log(id_proce);
$.ajax({
    url:'../php/inst_proc.php',
    type:'POST',    
}).done(function(resp){
    ...
    for(i=0;i<res.length;i++){
        ...
        if(id_proce===idt){
             ...
             alertify.confirm('Eliminar Datos', '¿Estas seguro de mandar a historial, este proceso de : '+ obj.data[i].instalacion_portuaria+'?', 
