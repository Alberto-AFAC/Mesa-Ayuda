...
diferencia = fecha2.diff(fecha1, 'days');
   ...
   if(fecha_agregada == '0000-00-00'){
     ...
     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].escuela_nautica+"</td><td>"+obj.data[i].profesion+"</td><td>"+fecha_exp+"</td><td>"+fecha_vig+"</td><td>"+obj.data[i].vig_cert+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";
   }else if(f2 < f1){

     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].escuela_nautica+"</td><td>"+obj.data[i].profesion+"</td><td>"+fecha_exp+"</td><td>"+fecha_vig+"</td><td>fecha vencida</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";     
 ...
 html +="<tr class='warning'><td>"+x+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].escuela_nautica+"</td><td>"+obj.data[i].profesion+"</td><td>"+fecha_exp+"</td><td>"+fecha_vig+"</td><td>faltan datos. faltan "+diferencia+" días</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";
        }else{
     html +="<tr><td>"+x+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].escuela_nautica+"</td><td>"+obj.data[i].profesion+"</td><td>"+fecha_exp+"</td><td>"+fecha_vig+"</td><td> faltan "+diferencia+" días</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";                            
            } 
          }                
        } 
...
$.ajax({
    ...
    for(i=0;i<res.length;i++){
        ...
        var instport = $("#modalEdicion #instport").val(obj.data[i].instport);
