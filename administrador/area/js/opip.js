...
diferencia = fecha2.diff(fecha1, 'days');
   ...
   if(fecha_agregada == '0000-00-00'){
     ...
     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].tipo+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].tel_extension+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>"+obj.data[i].vig_cert+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].director_general+"</td><td>"+obj.data[i].puerto+'. '+obj.data[i].estado+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";
   }else if(f2 < f1){

     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].tipo+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].tel_extension+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>fecha vencida</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].director_general+"</td><td>"+obj.data[i].puerto+'. '+obj.data[i].estado+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";     
 ...
 html +="<tr class='warning'><td>"+x+"</td><td>"+obj.data[i].tipo+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].tel_extension+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].celular_24hrs+"</td><td>faltan datos. faltan "+diferencia+" días</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].director_general+"</td><td>"+obj.data[i].puerto+'. '+obj.data[i].estado+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";
        }else{
     html +="<tr><td>"+x+"</td><td>"+obj.data[i].tipo+"</td><td>"+obj.data[i].opip_nombre+"</td><td>"+obj.data[i].tel_extension+"</td><td>"+obj.data[i].correo_opip+"</td><td>"+obj.data[i].celular_24hrs+"</td><td> faltan "+diferencia+" días</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].director_general+"</td><td>"+obj.data[i].puerto+'. '+obj.data[i].estado+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editar("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNo("+'"'+obj.data[i].id+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";                            
            } 
          }        
        } 
...
$.ajax({
    ...
    for(i=0;i<res.length;i++){
        ...
        if(id===idt){
             ...
             alertify.confirm('Eliminar Datos', '¿Esta seguro de eliminar el registro instport: '+ obj.data[i].instport+'?', 
