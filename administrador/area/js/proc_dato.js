...
html = '<div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"> <div class="col-sm-12"><table id="example" class="table table-striped table-bordered dataTable table table-hover" style="width:100%" role="grid" aria-describedby="example_info"><thead><tr><th><i class="fa fa-sort-numeric-asc"></i></th><th><i></i> Numero</th><th><i></i> Instalación Portuaria</th><th><i></i> Estado</th><th><i></i>Ciclo</th><th><i></i>Epip</th><th><i></i>Ppip</th><th><i></i>Aud_Cert</th><th><i></i>DCIP Exp.</th><th><i></i>DCIP Vig.</th><th>Holog.</th><th colspan="2">Auditoria / Resellado 1 </th><th colspan="2">Auditoria / Resellado 2 </th><th colspan="2">Auditoria / Resellado 3 </th><th colspan="2">Auditoria / Resellado 4 </th><th><i></i>Acción</th></tr></thead><tbody>';
...
if(fecha_agregada == '0000-00-00'){
     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].instpro+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+obj.data[i].estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+'sin tramitar'.fontcolor('red')+"</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";
}else if(f2vig < f1){
     html +="<tr class='danger'><td>"+x+"</td><td>"+obj.data[i].instpro+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+obj.data[i].estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' vencida'.fontcolor('red')+"</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";  
}else{

if(obj.data[i].instpro == "" || obj.data[i].instalacion_portuaria == "" || obj.data[i].estado == "" || obj.data[i].puerto == "" || obj.data[i].epip == "" || obj.data[i].ppip == "" || obj.data[i].aud_cert == "" || obj.data[i].re_ac == "" || obj.data[i].dcip_exp == "" || obj.data[i].dcip_vig == "" || obj.data[i].holograma == "" || obj.data[i].auditoria1 == "" || obj.data[i].resellado1 == "" || obj.data[i].auditoria2 == "" || obj.data[i].resellado2 == "" || obj.data[i].auditoria3 == "" || obj.data[i].resellado3 == "" || obj.data[i].auditoria4 == "" || obj.data[i].resellado4 == "" || obj.data[i].actividad_realizar == "" || obj.data[i].actividad_vigencia == "" || obj.data[i].status == "" || obj.data[i].activo_historico == "" || obj.data[i].tipo == "" || obj.data[i].obser == ""){
   html +="<tr class='warning'><td>"+x+"</td><td>"+obj.data[i].instpro+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+obj.data[i].estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' fal. '+diferencia+" días</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";  
}else{
   html +="<tr><td>"+x+"</td><td>"+obj.data[i].instpro+"</td><td>"+obj.data[i].instalacion_portuaria+"</td><td>"+obj.data[i].puerto+', '+obj.data[i].estado+"</td><td>"+ciclo+"</td><td>"+fec_epip+"</td><td>"+fec_ppip+"</td><td>"+fec_aud_cert+"</td><td>"+fec_dcip_exp+"</td><td>"+fec_dcip_vig+' fal. '+diferencia+" días</td><td>"+obj.data[i].holograma+"</td><td>"+fec_auditoria1+"</td><td>"+fec_resellado1+"</td><td>"+fec_auditoria2+"</td><td>"+fec_resellado2+"</td><td>"+fec_auditoria3+"</td><td>"+fec_resellado3+"</td><td>"+fec_auditoria4+"</td><td>"+fec_resellado4+"</td><td><div class='btn-group'><a class='Editar btn btn-warning' href='#' data-toggle='modal' data-target='#modalEdicion' onclick='Editarip("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-pencil'></i></a><a href='#' class='btn btn-danger' onclick='preguntarSiNoIP("+'"'+obj.data[i].id_proc+'"'+")'><i class='fa fa-trash-o'></i></a></div></td></tr>";    
      }
          }
...
$.ajax({
    ...
    for(i=0;i<res.length;i++){
        var idt = obj.data[i].id_proc;
        if(id_proc===idt){        


        var idip = $("#modalEdicion #idip").val(obj.data[i].id_proc);    
        var instpro = $("#modalEdicion #numero").val(obj.data[i].instpro);
        ...
        var epip = $("#modalEdicion #epip").val(obj.data[i].epip);        
        var ppip = $("#modalEdicion #ppip").val(obj.data[i].ppip);                
        var aud_cert = $("#modalEdicion #aud_cert").val(obj.data[i].aud_cert);        
        var dcip_exp = $("#modalEdicion #dcip_exp").val(obj.data[i].dcip_exp);        
        var dcip_vig = $("#modalEdicion #dcip_vig").val(obj.data[i].dcip_vig);        
        var holograma = $("#modalEdicion #holograma").val(obj.data[i].holograma);        
        var auditoria1 = $("#modalEdicion #auditoria1").val(obj.data[i].auditoria1);        
        var resellado1 = $("#modalEdicion #resellado1").val(obj.data[i].resellado1);        
        var auditoria2 = $("#modalEdicion #auditoria2").val(obj.data[i].auditoria2);        
        var resellado2 = $("#modalEdicion #resellado2").val(obj.data[i].resellado2);        
        var auditoria3 = $("#modalEdicion #auditoria3").val(obj.data[i].auditoria3);        
        var resellado3 = $("#modalEdicion #resellado3").val(obj.data[i].resellado3);        
        var auditoria4 = $("#modalEdicion #auditoria4").val(obj.data[i].auditoria4);        
        var resellado4 = $("#modalEdicion #resellado4").val(obj.data[i].resellado4);        
        var activo_historico = $("#modalEdicion #activo_historico").val(obj.data[i].activo_historico);        
...
function preguntarSiNoIP(id_proc){
    console.log(id_proc);
$.ajax({
    url:'../php/datos_proc.php',
    type:'POST',    
    ...
    for(i=0;i<res.length;i++){
        ...
        if(id_proc===idt){
             ...
             alertify.confirm('Eliminar Datos', '¿Esta seguro de eliminar el registro instpro: '+ obj.data[i].instpro+'?', 
            function(){ eliminarDatos(id_proc) }
...
$("#cero").slideDown("slow");
    ...
    $.ajax({
        ...
        type:'POST',
        data:'idi='+idi+'&id_ip='+id_ip+'&opcion=proceder'
