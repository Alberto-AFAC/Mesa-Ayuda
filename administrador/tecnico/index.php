...
<body>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
               <img src="../../img/afac.png" style="float: right; width: 90px;margin-top: 0.8em">         <h1 class="page-header">Técnicos</h1>                    
           </div>
           <!-- /.col-lg-12 -->
       </div>
        ...
        <div id="cuadro1" class="col-lg-12">
            <div class="panel panel-default">                  
                <div style="padding: 0;" class="panel-heading"> 
                    <button title="Agregar usuario" type="button" style="color:blue;" class="btn btn-default" data-toggle="modal" onclick="regisTec()"><i class='fa fa-street-view text-info' >+</i></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-0 col-sm-8">
                                <label>Nombre</label>
                                <select style="width: 100%" class="form-control" class="selectpicker" name="idusu" id="idusu" type="text" data-live-search="true">
                                    <option selected></option> 
                                    <?php while($rio = mysqli_fetch_row($usua)):?>
                                      <option value="<?php echo $rio[0]?>"><?php echo $rio[1].' '.$rio[2]?></option>
                                  <?php endwhile; ?>
                              </select>
                          </div>
                          ...
                          <div class="col-sm-offset-0 col-sm-4">
                             ...
                             <select style="width: 100%" class="form-control" class="selectpicker" name="privilg" id="privilg" type="text" data-live-search="true">
...
<div class="form-group"><br>
<div class="col-sm-offset-0 col-sm-2">
<button type="button" id="button" class="btn btn-block btn-primary" onclick="tecnico();">Aceptar</button>
</div>
<b><p class="alert alert-danger text-center padding error" id="danger">Los datos ya están agregados </p></b>

<b><p class="alert alert-success text-center padding exito" id="exito">¡Se agregaron los datos con éxito!</p></b>
...
<script type="text/javascript">
    ...
    while($data = mysqli_fetch_array($resultado)){
     ...
     ['<?php echo $id;?>','<?php echo $data['nombre'].' '.$data['apellidos']?>', '<?php echo $data['privilegios']?>' ,'<?php echo $data['usuario']?>','<?php echo ''?>',"<?php 
