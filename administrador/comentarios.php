...
<div>
<input type="hidden" id="id_leer" name="id_leer" value="<?php echo $id?>">
...
$sql = "
SELECT id_usuario,nombre,apellidos FROM manejador 
INNER JOIN usuarios ON id_manejador = id_climan 
WHERE 
manejador.estado = 1 
and 
privilegios != 'cliente' 
...
?>
        <div class="col-sm-12 col-md-12 col-lg-12" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">  
            ...
            <input type="hidden" id="privi" name="privi" value="admin">
    ...
    $(document).ready(function(){
        $('#guardarnuevo').click(function(){
          ...
          opcion=$('#opcion').val();
            ...
            agregardatos(id_climan,comentar,id_usu,nombre,privi);
        });
