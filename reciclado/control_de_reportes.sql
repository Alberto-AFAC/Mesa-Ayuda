...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-04-2021 a las 21:31:06
...
(3, 'ADOLFO', 'LOPEZ RESENDIZ ', 1, 26214, 'alopezre@sct.gob.mx', '0', 7132719, 0),
(4, 'ANA MARGARITA', 'SANCHEZ TALAVERA BEILES', 37, 26002, 'beiles.sanchez@sct.gob.mx', '0', 7137503, 0),
(5, 'VELIA', 'RAMIREZ MAYA', 1, 26405, 'vramimay@sct.gob.mx', '0', 5110367, 0),
...
(143, 'ANGEL ', 'CANSECO CABRERA', 19, 26040, 'angel.canseco@sct.gob.mx', 'Piso 5', 777, 0),
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;
