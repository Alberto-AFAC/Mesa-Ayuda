...
<div class="row">
    <div class="col-sm-12">
            <tr>    
                ...
                <?php if($ver[1]==$idu){?>
                <td><b>Para:&nbsp;&nbsp;<?php echo $ver[9].' '.$ver[10];?></b></td>
                <?php }else {?>
...
cliente.apellidos 
FROM usuarios 
INNER JOIN comentario ON id_usu = id_usuario 
INNER JOIN cliente on id_cliente = usuarios.id_climan 
WHERE usuarios.privilegios = 'cliente' 
and comentario.id_climan = $idu 
and comentario.visto = 0 
and comentario.estado = 1 
order by id asc";
    $con =0;   
$result=mysqli_query($conexion,$sql);
                while($ver=mysqli_fetch_row($result)){ 
...
SELECT DISTINCT id_climan,nombre FROM comentario WHERE id_usu = $idu and estado = 1 ORDER BY id_climan ASC
...
WHERE 
id_climan = $idu and estado = 1 and id_usu = $n
or 
id_usu = $idu and estado = 1 and id_climan = $n
order by id asc";
