...
<form  class="form-horizontal" action="" method="POST" id="frmMasAct" name="formulario" onsubmit="return agregar_mas_tarea(this)" >
 <div id="agrmast" class="col-sm-12 col-md-12 col-lg-12" class="modal fade" id="modalAgrmast" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
...
<input type="hidden" id="id_tareas" name="id_tareas" value="0">
...
<input type="hidden" id="opcion" name="opcion" value="registrar"> 
    ...
    <label for="finicio">Inicia tarea</label>
    <input id="finicio_" name="finicio_" type="text" class="form-control" disabled>
    </div>
    <div class="col-sm-offset-0 col-sm-5">
    <label for="ftermino">Finaliza tarea</label>
    ...
    <div class="form-group">    
    <div class="col-sm-offset-1 col-sm-10">
    <label for="descripción">Descripción tarea</label>
    <textarea rows="3" id="descripcion_" name="descripcion_" type="text" class="form-control" ></textarea></div>
    </div>  

    <div class="form-group"><br>
    <div class="col-sm-offset-1 col-sm-10">
    <button type="button" class="btn btn-primary" onclick="agregar_mas_tarea();">Guardar</button>
    </div>
    </div>
    </div>
    </div>
 ...
 <div class="row">
    ...
    <button type="button" style="color:blue;" class="btn btn-default" data-toggle="modal" onclick="AgregarTarea()"><i class="glyphicon glyphicon-plus"></i> Agregar Tarea</button>
    ...
    <div>
        <form id="TareaEliminar" action="" method="POST">
            <input type="hidden" id="id_tareas" name="id_tareas" value="">
            ...
            <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
                            <h4 class="modal-title" id="modalActividadEliminarLabel">Eliminar Tarea</h4>
                        </div>
                        <div class="modal-body">                            
                            ¿Está seguro de eliminar esta tarea? <strong data-name=""></strong>
                                    
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="eliminar-tarea" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
    ...
    <div>
        <form id="TareaFinalizar" action="" method="POST">
            <input type="hidden" id="id_tareas" name="id_tareas" value="">
            <input type="hidden" id="id_act" name="id_act" value="">
            <input type="hidden" id="opcion" name="opcion" value="finaliza">
            <!-- Modal -->
            <div class="modal fade" id="modalFinalizar" tabindex="-1" role="dialog" aria-labelledby="modalFinalizarLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
                            <h4 class="modal-title" id="modalActividadFinalizarLabel">Finalizar Tarea</h4>
                            
                        </div>
                        <div class="modal-body">                            
                            ¿Desea finalizar tarea ? <strong data-name=""></strong>
                                    
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="finalizar-tarea" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
 ...
 <div id="dettar" class="col-sm-12 col-md-12 col-lg-12" class="modal fade" id="modalDetalles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">  
    <div class="row">
    <div class="modal-body">    
...
<form  class="form-horizontal" action="" method="POST" id="EditarTarea" name="formulario" >


 <div id="editar" class="col-sm-12 col-md-12 col-lg-12" id="modalEditar" tabindex="-1" role="dialog">
...
<input id="nombre" name="nombre" type="text" class="form-control" autofocus>
    ...
    <div class="form-group">   
    <div class="col-sm-offset-1 col-sm-5">
    <label for="fecha_inicio">Inicia tarea</label>
...
<textarea id="tar_descrip" rows="3" name="tar_descrip" type="text" class="form-control"></textarea>
</div>
</div>
<div class="form-group"><br>
<div class="col-sm-offset-1 col-sm-10">
<!--<input type="submit" class="btn btn-primary" value="Guardar">-->
<button type="button" class="btn btn-primary" onclick="editar_tarea();">Guardar</button>
</div>
</div>
</div>
