...
session_start();
 ...
 $id = $_SESSION['usuario']['id_climan'];
	$query = "SELECT count(*) as conteo FROM proyecto INNER JOIN actividades ON idproyecto = id_pro INNER JOIN tareas ON id_activ = id_act WHERE id_man = $id and tareas.estado = 1";
