	...
	<?php 
				...
				if(isset($_SESSION['consulta'])){
					if($_SESSION['consulta'] > 0){
						...
						$sql="SELECT id_activ,nombre,DATE_FORMAT(fecha_inicio, '%d/%m/%Y'),DATE_FORMAT(fecha_termino, '%d/%m/%Y') from actividades where id_activ='$idp'";						
...
<form  class="form-horizontal" action="" method="POST" id="formUsuario" name="formulario" onsubmit="return agregar_tarea(this)" >
 <div id="agrtar" class="col-sm-12 col-md-12 col-lg-12" class="modal fade" id="AgregarActividad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    ...
    <div class="modal-header">
        ...
        <button type="button" id="btn_listar" class="close" data-dismiss="modal" aria-label="Close"><a href="ingresar_tareas.php"><span aria-hidden="true">&times;</span></a></button>
...
<input type="hidden" id="opcion" name="opcion" value="registrar">
	...
	<input id="id_activ" name="id_activ" class="form-control" value="<?php echo $ver[0] ?>" autofocus>
	</div>
	</div>
...
<?php for($y=$Yi; $y<=$Yt; $y++){ ?>
    ...
    <div class="col-sm-offset-1 col-sm-10">
    <button type="button" class="btn btn-primary" onclick="agregar_tarea();">Guardar</button>
