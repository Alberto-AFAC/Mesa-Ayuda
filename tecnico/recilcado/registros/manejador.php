...
<form  class="form-horizontal" action="" method="POST" id="registrationForm" name="formulario" onsubmit="return registrar(this)" >
 <div id="cuadro2" class="col-sm-12 col-md-12 col-lg-12" class="modal fade" id="DatosRegistrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    ...
    <div class="modal-header">
        <button type="button" id="btn_listar" class="close" data-dismiss="modal" aria-label="Close"><a href="manejador.php"><span aria-hidden="true">&times;</span></a></button>
...
<div class="alert alert-info text-center" style="display:none;" id="aviso_contraseña">
...
<div class="modal-body">
<input type="hidden" id="id_manejador" name="id_manejador" value="0">
...
<button type="button" class="btn btn-primary" onclick="modificar();">Guardar</button>
 ...
 <div class="row">
        ...
        <button type="button"  style="color:#611BBD;" class="btn btn-default" data-toggle="modal" onclick="DatosRegistrar()"><i class="fa fa-user-plus"></i> Agregar</button> 
         ...
         <p style="text-align: center; float: left; width:90%; " class="mensaje"></p>
               ...
               <div class="panel-body">             
                <table id="manejador" class="table table-striped table-bordered table-hover"  cellspacing="0" width="100%">
                    <thead>
                        <tr>                                
                            <th>Nombre</th>
                            <th>Apellidos</th>
    ...
    <div>
        <form id="frmEliminarManejador" action="" method="POST">
            <input type="hidden" id="id_manejador" name="id_manejador" value="">
            <input type="hidden" id="opcion" name="opcion" value="eliminar">
            <input type="hidden" id="privilegios" name="privilegios" value="manejador" />
            <!-- Modal -->
            <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
                            <h4 class="modal-title" id="modalEliminarLabel">Eliminar Datos</h4>
                        </div>
                        <div class="modal-body">                            
                            ¿Está seguro de eliminar estos datos? <strong data-name=""></strong>
                            <!--<input id="nombre" name="nombre" />-->              
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="eliminar-manejador" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
