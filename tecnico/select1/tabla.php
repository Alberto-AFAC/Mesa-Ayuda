...
switch ($id) {
  case "1":?>
            ...
            <select style="width: 100%;" id="intervencion" class="form-control" class="selectpicker" name="intervencion" type="text" data-live-search="true">
...
<div class="col-sm-offset-0 col-sm-4"><select style="width: 100%;" id="intervencion" class="form-control" class="selectpicker" name="intervencion" type="text" data-live-search="true" disabled=""><option value="x">SELECCIONE OPCIÓN</option></select></div>
<?php } ?>
