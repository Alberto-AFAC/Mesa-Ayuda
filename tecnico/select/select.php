...
switch ($id) {
  ...
  <select style="width: 100%;" id="descripcion" class="form-control" class="selectpicker" name="descripcion" type="text" data-live-search="true">
...
<div class="col-sm-offset-0 col-sm-4"><select style="width: 100%;" id="descripcion" class="form-control" class="selectpicker" name="descripcion" type="text" data-live-search="true" disabled=""><option value="0">DESCRIPCIÓN</option></select></div>
<?php } ?>
