function agrEqpo() {
    ...
    datos = asignado + '*' + n_empleado + '*' + num_invntraio + '*' + marca_cpu + '*' + serie_cpu + '*' + memoria_ram + '*' + procesador + '*' + velocidad_proc + '*' + uni_disc_flax + '*' + disco_duro + '*' + serie_teclado + '*' + serie_monitor + '*' + version_windows + '*' + version_office + '*' + serie_mouse + '*' + direccion_ip + '*' + nombre_equipo + '*' + servicio_internet + '*' + tipo_equipo + '*' + ubicacion;


    if (n_empleado == '' || num_invntraio == '0' || marca_cpu == '0' || serie_cpu == '0' || memoria_ram == '0' || procesador == '0' || velocidad_proc == '0' || uni_disc_flax == '0' || disco_duro == '0' || serie_teclado == '0' || serie_monitor == '0' || version_windows == '0' || version_office == '0' || serie_mouse == '0' || direccion_ip == '0' || nombre_equipo == '0' || servicio_internet == '0' || tipo_equipo == '0' || ubicacion == '0') {
        ...
        $.ajax({
            url: '../../php/agrEqpo.php',
            type: 'POST',
            data: 'n_empleado=' + n_empleado + '&asignado=' + asignado + '&num_invntraio=' + num_invntraio + '&marca_cpu=' + marca_cpu + '&serie_cpu=' + serie_cpu + '&memoria_ram=' + memoria_ram + '&procesador=' + procesador + '&velocidad_proc=' + velocidad_proc + '&uni_disc_flax=' + uni_disc_flax + '&disco_duro=' + disco_duro + '&serie_teclado=' + serie_teclado + '&serie_monitor=' + serie_monitor + '&version_windows=' + version_windows + '&version_office=' + version_office + '&serie_mouse=' + serie_mouse + '&direccion_ip=' + direccion_ip + '&nombre_equipo=' + nombre_equipo + '&servicio_internet=' + servicio_internet + '&tipo_equipo=' + tipo_equipo + '&ubicacion=' + ubicacion + '&opcion=agreqpo'
...
function edtEqpo() {
    ...
    if (n_empleado == 'x' || asignado == '' || id_equipo == '0' || num_invntraio == '0' || marca_cpu == '0' || serie_cpu == '0' || memoria_ram == '0' || procesador == '0' || velocidad_proc == '0' || uni_disc_flax == '0' || disco_duro == '0' || serie_teclado == '0' || serie_monitor == '0' || version_windows == '0' || version_office == '0' || serie_mouse == '0' || direccion_ip == '0' || nombre_equipo == '0' || servicio_internet == '0' || tipo_equipo == '0' || ubicacion == '0') {
